...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
    ...
    public interface DismissCallbacks {
         ...
         * positions.
         *
         * @param listView               The originating {@link ExpandableStickyListHeadersListView}.
         * @param reverseSortedPositions An array of positions to dismiss, sorted in descending
         *                               order for convenience.
         */
        void onDismiss(ExpandableStickyListHeadersListView listView, int[] reverseSortedPositions);
    }
     ...
     */
    public SwipeDismissListViewTouchListener(ExpandableStickyListHeadersListView listView, DismissCallbacks callbacks) {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                mListView.setIsScrolling(false);

                // TODO: ensure this is a finger, and set a flag

                // Find the child view that was touched (perform a hit test)
                Rect rect = new Rect();
                int childCount = mListView.getListChildCount();
                ...
                for (int i = 0; i < childCount; i++) {
                    child = mListView.getListChildAt(i);
